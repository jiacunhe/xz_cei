...
public class MyTools {
	...
	public static String KJ_DESCRIP;
	public static String KJ_TEANAME;
	...
	public static void loadConfigurations() {
		...
		try {
			...
			KJ_DESCRIP = p.getProperty("KJ_DESCRIP");
			KJ_TEANAME = p.getProperty("KJ_TEANAME");
		...
		new Handler().postDelayed(new Runnable() {
			...
			public void run() {
				try {
					...
					mPopupWindow.showAtLocation(((Activity) context)
