...
public class InformationOne extends ContainerActivity implements OnClickListener,
		OnItemClickListener {
		...
		public void dispatchMessage(Message msg) {
			...
			case LISTVIEW:
				InformationAdapter adapter = new InformationAdapter(
						InformationOne.this, R.layout.inf_list_item, news,
						currentFunctionId);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.infomation_one);
	...
	private void init() {
		...
		list.setOnItemClickListener(InformationOne.this);
	...
	private void initData() {
		...
		if(columnEntries.size()>=8){
			columnEntriesnew.add(columnEntries.get(4));
			columnEntriesnew.add(columnEntries.get(5));
			columnEntriesnew.add(columnEntries.get(6));
			columnEntriesnew.add(columnEntries.get(7));
		}else{
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		case R.id.read_report_main_lv:
			...
			intent.setClass(InformationOne.this, InformationReadActivity.class);
			if (new2.getIsfree().equals("1")) {
				InformationOne.this.startActivity(intent);
			} else {
				MyTools.exitShow(InformationOne.this, getWindow()
						.getDecorView(), "未购买该栏目！");
			}
			break;
		}
	...
	public void onClick(View v) {
		...
		case R.id.imageView1:
			InformationOne.this.finish();
			intent = new Intent(InformationOne.this, InformationActivity.class);
			startActivity(intent);
			break;
		case R.id.zjzx_search:
			intent = new Intent(InformationOne.this, InfoSearchActivity.class);
			startActivity(intent);
			break;
		case R.id.zjzx_botton_1:
			break;
		case R.id.zjzx_botton_2:
			intent = new Intent(InformationOne.this, InformationTwo.class);
			startActivity(intent);
			break;
		case R.id.zjzx_botton_3:
			intent = new Intent(InformationOne.this, InformationThree.class);
			startActivity(intent);
			break;
		case R.id.zjzx_botton_4:
			if (!loginName.equals("")) {
				intent = new Intent(InformationOne.this,
	...
	private void refreshListData(final String functionId, final int operationId) {
		...
		new Thread((new Runnable() {
			...
			public void run() {
				...
				switch (operationId) {
				case LISTVIEW:
					if (((CeiApplication) InformationOne.this
