...
public class InformationThree extends ContainerActivity implements OnClickListener,
		OnItemClickListener {
		...
		public void dispatchMessage(Message msg) {
			...
			case LISTVIEW:
				InformationAdapter adapter = new InformationAdapter(
						InformationThree.this, R.layout.inf_list_item, news,
						currentFunctionId);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.infomation_three);
	...
	private void init() {
		...
		list.setOnItemClickListener(InformationThree.this);
	...
	private void initData() {
		...
		if(columnEntries.size()>=10){
			columnEntriesnew.add(columnEntries.get(8));
			columnEntriesnew.add(columnEntries.get(9));
		}else{
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		case R.id.read_report_main_lv:
			...
			intent.setClass(InformationThree.this,
					InformationReadActivity.class);
			if (new2.getIsfree().equals("1")) {
				InformationThree.this.startActivity(intent);
			} else {
				MyTools.exitShow(InformationThree.this, getWindow()
						.getDecorView(), "未购买该栏目！");
			}
			break;
		}
	...
	public void onClick(View v) {
		...
		case R.id.imageView1:
			InformationThree.this.finish();
			intent = new Intent(InformationThree.this, InformationActivity.class);
			startActivity(intent);
			break;
		case R.id.zjzx_search:
			intent = new Intent(InformationThree.this, InfoSearchActivity.class);
			startActivity(intent);
			break;
		case R.id.zjzx_botton_1:
			intent = new Intent(InformationThree.this, InformationOne.class);
			startActivity(intent);
			break;
		case R.id.zjzx_botton_2:
			intent = new Intent(InformationThree.this, InformationTwo.class);
			startActivity(intent);
			break;
		...
		case R.id.zjzx_botton_4:
			if (!loginName.equals("")) {
				intent = new Intent(InformationThree.this,
	...
	private void refreshListData(final String functionId, final int operationId) {
		...
		new Thread((new Runnable() {
			...
			public void run() {
				...
				switch (operationId) {
				case LISTVIEW:
					if (((CeiApplication) InformationThree.this
