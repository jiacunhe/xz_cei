...
public class HomePageActivity extends BaseActivity implements OnClickListener,
    ...
    private void showLoginBtnByUserName() {
        ...
        // 根据登录名来显示登陆按钮那个位置
        if (!loginName.equals("")) {
            ((TextView) findViewById(R.id.phone_study_login_text))
                    .setVisibility(View.VISIBLE);
            ((TextView) findViewById(R.id.phone_study_login_text)).setText(loginName);
        }else{
            findViewById(R.id.phone_study_login).setVisibility(View.VISIBLE);
        }
    }
    ...
    private void registEvent() {
        ...
        findViewById(R.id.phone_study_login).setOnClickListener(this);
