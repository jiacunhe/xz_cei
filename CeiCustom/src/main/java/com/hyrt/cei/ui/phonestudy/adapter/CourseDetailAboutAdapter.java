...
public class CourseDetailAboutAdapter extends BaseAdapter {
	...
	public CourseDetailAboutAdapter(Activity activity,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(
					R.layout.phone_studydetail_gridview_item, null);
			holder.classIcon = (ImageView) ((LinearLayout) convertView)
					.getChildAt(0);
			holder.title = (TextView) ((LinearLayout) convertView)
					.getChildAt(1);
