		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					if(u.getAphoneurl() != null && u.getAphoneurl().contains(".apk")){
						SharedPreferences settings = mContext.getSharedPreferences("down_url",Activity.MODE_PRIVATE);
						Editor editor = settings.edit();
						editor.putString("url", u.getApadurl());
						editor.commit();
					}
					int versionCode = getVersionCode(mContext);
					if (u.getApadversion() > versionCode) {
...
//					URL url = new URL("http://192.168.10.248:8091/HBT-MWPM/upload/apk/Cei(20130326111802).apk");
					...
					File apkFile = new File(mSavePath, u.getApadname());
