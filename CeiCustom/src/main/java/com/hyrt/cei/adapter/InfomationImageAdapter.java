...
public class InfomationImageAdapter extends BaseAdapter {
	private InformationMainActivity mContext;
	private List<InfoNew> data;
	public HashMap<Integer, Drawable> drawables = new HashMap<Integer, Drawable>();
	private AsyncImageLoader asyncImageLoader;
	private Gallery gallery;
	public InfomationImageAdapter(InformationMainActivity informationMainActivity,List<InfoNew> data,Gallery gallery,ImageView[] imageViews) {
		mContext = informationMainActivity;
		this.data=data;
		this.gallery=gallery;
		asyncImageLoader = ((CeiApplication) informationMainActivity.getApplication()).asyncImageLoader;
	}
