...
class PageTreeNode {
    ...
    private SoftReference<Bitmap> bitmapWeakReference;//�����ÿ���4ʵ���ڴ���еĸ� �ٻ��档ʹ���������ܷ�ֹ�ڴ�й¶����ǿ����Ľ�׳�ԡ�   
...
//    Rect��RectF���Ȳ�һ��Rect��ʹ��int������Ϊ��ֵ��RectF��ʹ��float������Ϊ��ֵ,�����ṩ�ķ���Ҳ��һ��
    ...
    private void invalidateChildren() {
        if (thresholdHit() && children == null && isVisible()) {
            final int newThreshold = treeNodeDepthLevel * 10;
